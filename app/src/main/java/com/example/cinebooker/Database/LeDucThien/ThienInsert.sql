...
VALUES ('rap1.png', 'Rạp Chiếu A', 'Rạp chiếu hiện đại với các tiện ích cao cấp, không gian thoải mái.'),
       ('rap2.png', 'Rạp Chiếu B', 'Rạp chiếu phim với màn hình lớn và âm thanh vòm chất lượng cao.'),
       ('rap3.png', 'Rạp Chiếu C', 'Rạp chiếu được thiết kế sang trọng, phục vụ các bộ phim bom tấn.'),
       ('rap4.png', 'Rạp Chiếu D', 'Rạp chiếu phim với không gian ấm cúng, thích hợp cho các buổi chiếu nhỏ.'),
       ('rap5.png', 'Rạp Chiếu E', 'Rạp chiếu phim mới với các ghế ngồi thoải mái và hệ thống âm thanh hiện đại.'),
       ('rap6.png', 'Rạp Chiếu F', 'Rạp chiếu 3D với màn hình cực lớn, mang lại trải nghiệm tuyệt vời.'),
       ('rap7.png', 'Rạp Chiếu G', 'Rạp chiếu phục vụ cả phim quốc tế và nội địa với các lựa chọn phòng chiếu đa dạng.'),
       ('rap8.png', 'Rạp Chiếu H', 'Rạp chiếu với dịch vụ ăn uống tại chỗ, mang lại sự tiện lợi cho người xem.'),
       ('rap9.png', 'Rạp Chiếu I', 'Rạp chiếu công nghệ cao với hệ thống máy chiếu 4K và âm thanh Dolby Atmos.'),
       ('rap10.png', 'Rạp Chiếu J', 'Rạp chiếu với không gian hiện đại và đội ngũ nhân viên phục vụ chuyên nghiệp.');
GO
...
VALUES 
('logo.png', 'VoucherApp1', 1, N'Phần trăm', 10, '2024-12-31', N'Chưa sử dụng', 100),
('logo.png', 'VoucherApp2', 2, N'Giá tiền', 50000, '2024-12-31', N'Chưa sử dụng', 200),
('logo.png', 'VoucherApp3', 3, N'Phần trăm', 25, '2024-12-31', N'Chưa sử dụng', 150),
('logo.png', 'VoucherApp4', 4, N'Giá tiền', 100000, '2024-12-31', N'Chưa sử dụng', 75),
('logo.png', 'VoucherApp5', 5, N'Phần trăm', 15, '2024-12-31', N'Chưa sử dụng', 200),
('logo.png', 'VoucherApp6', 1, N'Giá tiền', 20000, '2024-12-31', N'Chưa sử dụng', 250),
('logo.png', 'VoucherApp7', 2, N'Phần trăm', 30, '2024-12-31', N'Chưa sử dụng', 300),
('logo.png', 'VoucherApp8', 3, N'Giá tiền', 70000, '2024-12-31', N'Chưa sử dụng', 120),
('logo.png', 'VoucherApp9', 4, N'Phần trăm', 20, '2024-12-31', N'Chưa sử dụng', 400),
