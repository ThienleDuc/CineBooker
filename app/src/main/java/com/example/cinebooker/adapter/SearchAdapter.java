package com.example.cinebooker.adapter;
...
import com.example.cinebooker.entity.searchMoviesEntity;
...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.SearchViewHolder> {
    ...
    public SearchAdapter(List<searchMoviesEntity> searchMoviesList) {
    ...
    public void onBindViewHolder(@NonNull SearchAdapter.SearchViewHolder holder, int position) {
        searchMoviesEntity search_movies=  searchMoviesList.get(position);
        ...
        holder.comment.setText(NumberFormatter.formatNumber(search_movies.getComment().doubleValue()));
